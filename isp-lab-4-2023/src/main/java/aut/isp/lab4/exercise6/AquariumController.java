...
public class AquariumController {
    ...
    public AquariumController(FishFeeder feeder, String manufacturer, String model, float feedingTime, float desiredPH, int temperature, LevelSensor levelSensor, TemperatureSensor temperatureSensor, Alarm alarm, Heater heater, PHSensor pHSensor, Alarm pHAlarm) {
        this.feeder = feeder;
    ...
    public void checkPH() {
        ...
        if (Math.abs(currentPH - desiredPH) > 0.2f) {
            pHAlarm.turnOn();
        } else {
            pHAlarm.turnOff();
        }
    ...
    public static void main(String[] args) {
        ...
        Alarm pHAlarm = new Alarm("AlarmCorp", "AlarmMaster 2000");
